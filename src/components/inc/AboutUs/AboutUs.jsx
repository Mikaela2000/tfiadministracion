...
const AboutUs = () => {
  return (
    <Container className={`mb-5 ${style.containerAbout}`}>
      <Row style={{ backgroundColor: '#fff', height: '70vh' }}>
        ...
        <div className={`d-flex justify-content-center align-items-center p-5 ms-5 ${style.containerAbajo}`} style={{ position: 'absolute', width: '90%' }}>
