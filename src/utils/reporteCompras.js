...
export const generateReporteCompras = (compras) => {
    const doc = new jsPDF();
    ...
    doc.text("Reporte de Compras", 14, 10); // Título en la posición X=14, Y=10
    ...
    doc.autoTable({
        ...
        startY: 30, // Ajusta la posición Y de la tabla para que no se solape con la fecha
    });
